...
class DeeplinkService {
  ...
  Future<void> initDeeplink() async {
    ...
    try {
      ...
      try {
        ...
        if (initialUri != null) {
          developer.log('Initial deep link: $initialUri', name: 'DEEPLINK_SERVICE');
      ...
      _isInitialized = true;
      developer.log('Deep link service initialized successfully', name: 'DEEPLINK_SERVICE');
    } catch (e) {
      developer.log('Failed to initialize deep link service: $e', name: 'DEEPLINK_SERVICE');
    }
  }
  ...
  void _handleDeeplink(Uri uri) {
    ...
    if (uri.scheme == 'acti' && uri.host == 'auth' && uri.path.contains('yandex_callback')) {
