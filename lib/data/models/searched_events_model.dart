...
SearchedEventsModel welcomeFromJson(String str) =>
    SearchedEventsModel.fromJson(json.decode(str));
...
class SearchedEventsModel {
  ...
  factory SearchedEventsModel.fromJson(Map<String, dynamic> json) =>
      SearchedEventsModel(
        total: json["total"],
        limit: json["limit"],
        offset: json["offset"],
