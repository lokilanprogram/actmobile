...
class UpdateHobbiesScreen extends StatefulWidget {
  ...
  @override
  State<UpdateHobbiesScreen> createState() => _UpdateHobbiesScreenState();
}

class _UpdateHobbiesScreenState extends State<UpdateHobbiesScreen> {
                  ...
                  PopNavButton(
                    ...
                    function: widget.fromUpdate
                        ...
                        : () {
                            ...
                            context.read<AuthBloc>().add(ActiSaveOnbordingEvent(
