...
class MyCardEventWidget extends StatelessWidget {
  ...
  final reccuringDays = organizedEvent.isRecurring ? getWeeklyRepeatText(organizedEvent.dateStart):null;
        ...
        child: Opacity(
          ...
          shape: RoundedRectangleBorder(
                    ...
                    child: Column(crossAxisAlignment: CrossAxisAlignment.start,
                      children: [
                        ...
                        Row(children: [
                         ...
                         organizedEvent.restrictions.any((restrict)=> restrict =='isAdults')? SvgPicture.asset('assets/icons/icon_adult.svg'):Container(),   
                        PopupMenuButton<int>(
            color: Colors.white,
            shape: RoundedRectangleBorder(
              borderRadius: BorderRadius.circular(15),
            ...
            child: const Icon(Icons.more_vert, color: Colors.black),
                              ...
                              SizedBox(height: 5,),
                        !organizedEvent.isRecurring ?Row(
                          children: [
                                                   ...
                                                   text: TextSpan(
                                                     ...
                                                     children: [
                                                       TextSpan(
                                                         ...
                                                         fontSize: 11.89,color: mainBlueColor,
                                                           fontFamily: 'Gilroy',),
                                                       ),
                                                       TextSpan(
                                                         ...
                                                         TextSpan(text: ' | ',style: TextStyle(color: mainBlueColor)),
                                                         TextSpan(text: '${organizedEvent.timeStart.substring(0,5)}-${organizedEvent.timeEnd.substring(0,5)}',style:TextStyle(fontFamily: 'Gilroy',fontSize: 11.89,color: mainBlueColor,fontWeight: FontWeight.w700),)
                                                     ],
                                                   ),
                ...
                ((user)=>user.user.photoUrl).toList()),
                  ...
                  Row(
                     children: [
                       ...
                       SizedBox(width: 10),
                       Text(  organizedEvent.restrictions.any((restrict)=>restrict == 'isUnlimited') ?'Неограниченно' :'Свободно ${organizedEvent.freeSlots} из ${organizedEvent.slots} мест',
