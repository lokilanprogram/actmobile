            ...
            Container(
                    decoration: BoxDecoration(
                      image: DecorationImage(
                        image: AssetImage("assets/images/image_events_list.png",),
                        fit: BoxFit.cover,
                      ),
                    ),
                  ),
            ...
            padding: EdgeInsets.only(top: MediaQuery.of(context).size.height * 0.6,right: 40,left: 40),
             child: Align(
               child: Column(mainAxisAlignment: MainAxisAlignment.center,crossAxisAlignment: CrossAxisAlignment.start,
                children: [
                  SvgPicture.asset('assets/texts/text_events_list.svg'),
                  SizedBox(height: 10,),
                  SvgPicture.asset('assets/texts/text_choose_event.svg'),
                  SizedBox(height: 30,),
                    ...
                    children: [
                      ...
                      Align(
                        ...
                        child: PopNavButton(
                          text: 'Далее',
                          function: (){
                          Navigator.push(context, MaterialPageRoute(builder: (context)=> EventsCreateScreen()));
                          },
                        ),
                      ),
                    ],
