    ...
    return BlocListener<ProfileBloc, ProfileState>(
      listener: (context, state) {
        ...
        if(state is ProfileGotEventDetailState){
          ...
          if(isBlocked){
            showAlertOKDialog(context, 'Мест нет, но вы можете написать организатору, возможно, он добавит вас в это мероприятие.');
          }
        }
        ...
        body:isLoading ? LoaderWidget(): SingleChildScrollView(
              ...
              Stack(
                children: [
                  ...
                  Positioned(
                      top: 50,
                      right: 20,
                      child: PopUpEventButtons(eventId: organizedEvent.id, blockFunction: () async {})),
                          ...
                          children: [
                           ...
                           SizedBox(
                            ...
                            child:  Row(
                              mainAxisAlignment: MainAxisAlignment.center,
                              children: [
                               organizedEvent.price == 0? buildTag('Бесплатное'):Container(),
          ...
          showAlertOKDialog(context,null,isTitled: true,title:  'Подтвердите почту');
                            ...
                            style: ElevatedButton.styleFrom(
                              ...
                              backgroundColor:isBlocked ? mainBlueColor: (isJoined ?Colors.red: Color.fromRGBO(98, 207, 102, 1)),
                              shape: RoundedRectangleBorder(
                                borderRadius: BorderRadius.circular(30),
                              ),
                            ),
                            child:  Text(
                            isBlocked ?'Написать организатору': (isJoined ? 'Не пойду': 'Пойду'),
                              style: TextStyle(
                                  color: Colors.white,
                                  fontSize: 16.46,
                                  fontFamily: 'Gilroy'),
