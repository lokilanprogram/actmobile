                                                            ...
                                                            children: [
                                                              ...
                                                              infoRow(
                                                                ...
                                                                organizedEvent
                                                                            .restrictions !=
                                                                        null
                                                                    ? (organizedEvent.restrictions.any((restrict) =>
                                                                            restrict ==
                                                                            'isUnlimited')
                                                                        ? 'Неограниченно'
                                                                        : 'Свободно ${organizedEvent.freeSlots} из ${organizedEvent.slots} мест')
                                                                      ...
                                                                      children: [
                                                                        Row(
                                                                          children: [
                                                                            CircleAvatar(
                                                                              radius: 21,
                                                                              backgroundImage: rewiewsModel.reviews[index].user.photoUrl != "" && rewiewsModel.reviews[index].user.photoUrl != null ? NetworkImage(rewiewsModel.reviews[index].user.photoUrl!) : AssetImage('assets/images/image_profile.png'),
                                                                            ),
                                                                            const SizedBox(width: 10),
                                                                            Column(
