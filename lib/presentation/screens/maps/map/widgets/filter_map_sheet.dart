...
class FilterMapSheet extends StatefulWidget {
  ...
  @override
  State<FilterMapSheet> createState() => _FilterMapSheetState();
}

class _FilterMapSheetState extends State<FilterMapSheet>
                                ...
                                child: AnimatedContainer(
                                  ...
                                  child: Text(
                                    ...
                                    style: TextStyle(
                                      fontSize: 11,
                                      color:
                                          filterProvider.selectedTimeFilter ==
                                                  'day'
                                              ? Colors.white
                                              : Colors.black,
                                      fontWeight: FontWeight.w500,
