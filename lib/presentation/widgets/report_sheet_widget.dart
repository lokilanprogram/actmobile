...
class ReportEventSheetWidget extends StatefulWidget {
  ...
  const ReportEventSheetWidget({super.key, required this.eventId});
            ...
            listener: (context, state) {
              if (state is ProfileReportedEventState) {
                ...
                showAlertOKDialog(context,
                    'Ваша жалоба отправлена. Спасибо, что помогаете нам становиться лучше.');
              }
            ...
            : Expanded(
                child: ListView(
                  ...
                  children: [
                    ...
                    buildOption('Насилие и вражда', context, () {
                      setState(() {
                        isSpecific = true;
                        complaints = complainViolence;
                      });
                    }),
                    buildOption('Продажа запрещённых товаров', context, () {
                      setState(() {
                        isSpecific = true;
                        complaints = complainItems;
                      });
                    }),
                    buildOption('Подозрительная активность', context, () {
                      setState(() {
                        isSpecific = true;
                        complaints = complainSuspect;
                      });
                    }),
                    buildOption('Откровенное изображение', context, () {
                      setState(() {
                        isSpecific = true;
            ...
            ? SizedBox(
                ...
                child: ElevatedButton(
                  onPressed: () {
                    ...
                    context.read<ProfileBloc>().add(ProfileReportEvent(
                        imageUrl: image?.path,
                        eventId: widget.eventId,
                        title: selectedIndex != null
                            ? complaints[selectedIndex!]['title']!
                            : 'Другое',
