...
class TabBarWidget extends StatefulWidget {
  ...
  const TabBarWidget(
      ...
      required this.firshTabText,
      required this.secondTabText,
      required this.requestLentgh,
      required this.recommendedLentgh});
  @override
